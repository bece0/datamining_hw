        ...
        <div class="container2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">DBSCAN</li>
            ...
            <div class="alert alert-info" role="alert">
                <?php  
                    ...
                    echo "Epsilon : <b>".$epsilon."</b><br>"; 
                    echo "Min Samples : <b>".$minsamples."</b><br>"; 
                ?>
            </div>
            <div>
                <?php 
                    require_once('../algorithms/DBSCAN.php');

                    //DBSCAN sınıfının nesnesi oluşturulur
                    $DBScanAlgoritmaNesnesi = new DBSCANAlg($OKUNACAK_DOSYA_ADI);
                    $hata = $DBScanAlgoritmaNesnesi->ParametreleriAyarla($epsilon, $minsamples, $xKolonAdi, $yKolonAdi);

                    //todo - $hata kontrol et

                    $result = $DBScanAlgoritmaNesnesi->result;
                ?>
            </div>
